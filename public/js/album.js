...
var resultsUser = document.querySelector(".share-users-results");
...
function searchUsers(keywords) {
  axios.get(window.location.origin + '/api/search/user/' + keywords).then(function (response) {
    ...
    var elementsNb = resultsUser.childElementCount;
...
function displayUsers(users) {
  users.forEach(function (user) {
    ...
    var labeluserCard = document.createElement("label");
    var userCard = document.createElement('input');
